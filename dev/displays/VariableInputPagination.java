...
public class VariableInputPagination
{
	...
	public VariableInputPagination(File plot_directory)
	{
		plots = new ArrayList<ImageView>();
		loadPlots(plot_directory);
	}

	public VariableInputPagination(String plot_directory)
	{
		plots = new ArrayList<ImageView>();
		loadPlots(plot_directory);
	}
	...
	private void loadPlots(File plot_directory)
	{
		for (File file : plot_directory.listFiles())
		{
			try
			{
				...
				ImageView image = new ImageView(file.getName());
